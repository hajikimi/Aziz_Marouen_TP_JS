...
document.write('<div id="game" >'+'<table border="0" align="center">');
for (i=1 ;i<(nbc/6)+1 ;i++) {
    document.write('<tr>');
    for (t = 1; t < 7; t++) {
        cpt++;
...
document.write('</table></div>'+
    ...
    '<table class="aff" align="center">'+
    '<tr><td width="200" align="center">'+
    'Nombre de coups '+
    '<input id="result" type="text"  id="result2" size="5">'+
    '</td><td width="100" align="center">'+
    '<input type="button" name="Submit" onClick="window.location=\'HardGame.html\'" value="Rejouer">'+
    '</td><td align="center">'+
