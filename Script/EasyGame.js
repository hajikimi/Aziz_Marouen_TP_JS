...
document.write('</table ></div>'+
    ...
    '<input type="button" name="Submit" onClick="window.location=\'EasyGame.html\'" value="Rejouer">'+
    '</td><td align="center">'+
    '<input type="button" name="Submit" onClick="window.location=\'Interface.html\'" value="Menu">'+
    '</td></tr><tr>'+
